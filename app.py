...
def github():
   ...
   # Daily Created Issues: just count issue_number per created_at date
    ...
    LSTM_API_URL = "https://forecast-service-972545317826.us-central1.run.app/api/forecast"
    LSTM_API_URL_PULLS = "https://forecast-service-972545317826.us-central1.run.app/api/forecast/pulls"
    LSTM_API_URL_BRANCHES = "https://forecast-service-972545317826.us-central1.run.app/api/forecast/branches"
...
def github_stars_chart():
    ...
    STAR_FORECAST_API = "https://forecast-service-972545317826.us-central1.run.app/api/stars"
...
def github_forks_chart():
    ...
    FORK_FORECAST_API = "https://forecast-service-972545317826.us-central1.run.app/api/forks"
